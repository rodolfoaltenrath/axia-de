...
fn drawWindowControl(cr: *c.cairo_t, rect: Rect, kind: WindowControlKind, hovered: bool) void {
    if (hovered) {
...
fn drawAccentGlyph(cr: *c.cairo_t, rect: Rect, glyph: []const u8, color: [3]f64) void {
